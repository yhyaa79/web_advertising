...
class Category(models.Model):
    ...
    PLATFORM_CATEGORIES = [
        ('content_media', 'محتوایی و رسانه‌ای', [
            ('website_blog', 'وبلاگ و سایت محتوایی'),
            ('website_news_magazine', 'خبری و مجله آنلاین'),
            ('content_podcast', 'پادکست و کانال صوتی'),
            ('content_newsletter', 'خبرنامه و ایمیل مارکتینگ'),
            ('content_adsense_channel', 'سایت درآمدزا (تبلیغات)'),
            ('content_ebook_course', 'کتاب الکترونیکی و دوره ضبط‌شده'),
            ('website_other', 'سایر محتوایی'),
        ]),
        ('ecommerce', 'فروشگاهی', [
            ('ecommerce_woocommerce', 'فروشگاه وردپرسی (ووکامرس)'),
            ('ecommerce_shopify', 'فروشگاه شاپیفای'),
            ('ecommerce_custom', 'فروشگاه اختصاصی'),
            ('ecommerce_marketplace_shop', 'فروشگاه در مارکت‌پلیس (قطعی، دیجیکالا، ترکیب)'),
            ('ecommerce_dropship', 'فروشگاه دراپ‌شیپینگ'),
            ('ecommerce_woo_fba_dropship', 'فروشگاه تحت‌سقف یا سفارش‌سازی'),
            ('ecommerce_other', 'سایر فروشگاه‌ها'),
        ]),
        ('software', 'نرم‌افزاری و اپلیکیشن', [
            ('app_saas', 'سرویس SaaS / درج شده‌ای'),
            ('app_android', 'اپلیکیشن اندروید'),
            ('app_ios', 'اپلیکیشن iOS'),
            ('app_cross_platform', 'اپلیکیشن کراس‌پلتفرم'),
            ('app_game_mobile', 'بازی موبایل'),
            ('app_telegram_bot', 'ربات و ابزار تلگرام'),
            ('app_web_tool', 'ابزار و وب‌اپلیکیشن'),
            ('app_other', 'سایر نرم‌افزارها'),
        ]),
        ('social_media', 'شبکه اجتماعی و انجمن', [
            ('social_instagram', 'حساب و صفحه اینستاگرام'),
            ('social_telegram_channel', 'کانال تلگرام'),
            ('social_telegram_group', 'گروه و کمیونیتی تلگرام'),
            ('social_youtube', 'کانال یوتیوب'),
            ('social_aparat', 'کانال آپارات'),
            ('social_twitter_x', 'حساب توییتر / X'),
            ('social_tiktok', 'کانال تیک‌تاک'),
            ('website_forum_community', 'انجمن و فروم آنلاین'),
            ('social_linkedin', 'صفحه و پروفایل LinkedIn'),
            ('social_other', 'سایر شبکه‌های اجتماعی'),
        ]),
        ('service_business', 'خدماتی و آموزشی', [
            ('service_agency', 'آژانس دیجیتال / تیم خدماتی'),
            ('service_consulting', 'مشاوره و کوچینگ'),
            ('service_membership_site', 'سایت اشتراک ویژه (محتوای محدود)'),
            ('service_marketplace', 'مارکت‌پلیس و پلتفرم معاملاتی'),
            ('service_booking', 'سیستم رزرو، نوبت‌دهی و جلسه‌بندی'),
            ('website_educational', 'پلتفرم آموزشی و دوره آنلاین'),
            ('website_job_board', 'پورتال کاریابی و استخدام'),
            ('website_real_estate', 'سایت و پلتفرم املاک'),
            ('service_sms_marketing', 'سرویس ارسال پیامک و ایمیل'),
            ('service_other', 'سایر خدمات'),
        ]),
        ('domain', 'دامنه', [
            ('domain_ir', 'دامنه .ir'),
            ('domain_com', 'دامنه .com'),
            ('domain_international_other', 'سایر دامنه‌های بین‌المللی'),
            ('domain_brandable', 'دامنه برندی و کوتاه'),
            ('domain_portfolio', 'مجموعه دامنه'),
        ]),
        ('other', 'سایر', [
            ('other_misc', 'متفرقه و سایر دارایی‌ها'),
        ]),
    ]
